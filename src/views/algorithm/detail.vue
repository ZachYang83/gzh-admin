    ...
    <div class = "main-content">
      ...
      <div class = "sub-intro">
        ...
        <div class = "relative-algorithm">
          <div class = "rel-item" v-for = "(item,index) in relatives" @click = "goToDetail(item.id)">
            <div class = left>
              <img src="@/assets/images/icon-alg.png" alt="算法图标" v-if = "item.filingType === 'algorithm'">
              <img src="@/assets/images/icon-model.png" alt="大模型图标" v-if = "item.filingType === 'model'">
            </div>
            <div class = right>
                <div class="algName">{{item.productName }}</div>
