  ...
  <div class="cj-table-wrap">
    ...
    <div class="main-content">  
      <div class = "main-table">
        <BoardType1 v-for = "(data) in sceneData" :ifimg="false" detailName="supDetail" :id="data.id" :title=data.productName key1="支持单位" key2="行业领域" key3="简介" :value1=data.supportingUnit :value2=data.sceneClass :value3=data.discription></BoardType1>
      </div>
