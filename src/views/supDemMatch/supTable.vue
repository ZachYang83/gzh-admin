<template>
  <div class="cj-table-wrap">
    <div class="main-title">
      <Tybtl title="供给超市" attachment = "[切换为需求]" attachmentLink = "demTable"></Tybtl>
    </div>
    ...
    <div class="main-content">  
      <div class = "main-table">
        <BoardType1 v-for = "(data) in sceneData" :key="data.id" :ifimg="false" detailName="supDetail" :id="data.id" :title=data.productName key1="支持单位" key2="行业领域" key3="简介" :value1=data.supportingUnit :value2=data.sceneClass :value3=data.discription></BoardType1>
      </div>
...
const scenes = ref(["全部", "智能制造", "医药健康", "综合交通", "城市治理", "教育教学", "商贸金融", "智能办公"]);
